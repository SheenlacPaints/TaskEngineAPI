...
namespace TaskEngineAPI.Controllers
{
...

    {
     ...
     [FromQuery] int? status = null)
        ...
        public async Task<IActionResult> Gettaskapprove([FromQuery] string? searchText = null, [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
        {
            try
            {
                // 🔐 Extract token
                ...
                var queryString = queryParams.Any() ? "?" + string.Join("&", queryParams) : "";
                // 🔗 Build full URL with encrypted query             
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/TaskMaster/Gettaskapprove?searchText={searchText}&page={page}&pageSize={pageSize}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                // 📡 Forward request
                var response = await _httpClient.SendAsync(requestMessage);
        ...
        public async Task<IActionResult> GettaskReject([FromQuery] string? searchText = null, [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
        {
            try
            {
                // 🔐 Extract token
                ...
                var queryString = queryParams.Any() ? "?" + string.Join("&", queryParams) : "";
                // 🔗 Build full URL with encrypted query             
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/TaskMaster/GettaskReject?searchText={searchText}&page={page}&pageSize={pageSize}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                // 📡 Forward request
                var response = await _httpClient.SendAsync(requestMessage);
        ...
        [Authorize]
        [HttpGet("GettaskHold")]
        public async Task<IActionResult> GettaskHold([FromQuery] string? searchText = null, [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
        {
            try
            {
                // 🔐 Extract token
       ...
       [FromQuery] bool? isActive = null)
        ...
        public async Task<IActionResult> Getmetadataviewdataid([FromQuery] int id)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(jwtToken))
                    return Unauthorized("Missing Authorization token.");
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/TaskMaster/Getmetadataviewdataid?id={id}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> CreateProjectMaster([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}Project/CreateProjectMaster");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> CreateAnalyticalhub([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}Analytical/CreateAnalyticalhub");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> CreateProjectDetails([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}Project/CreateProjectDetails");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateProjectDetails([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Put, $"{_baseUrl}Project/UpdateProjectDetails");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> GetAnalyticalhubbyid([FromQuery] int id)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(jwtToken))
                    return Unauthorized("Missing Authorization token.");
                // 🔗 Build full URL with encrypted query             
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/Analytical/GetAnalyticalhubbyid?id={id}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> GetProjectList()
        {
            try
            {
                ...
                // Attach token to outbound request
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}Project/GetProjectList");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> CreateProjectVersion([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}Project/CreateProjectVersion");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpPost("FetchattandanceAPIAsync")]
        public async Task<IActionResult> FetchattandanceAPIAsync([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}TaskMaster/FetchattandanceAPIAsync");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> FetchBoardAPIIntegrationAPIAsync([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}APIIntegration/FetchBoardAPIIntegrationAPIAsync");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpGet("FetchAPIReportingAsync")]
        public async Task<IActionResult> FetchAPIReportingAsync()
        {
            try
            {
                ...
                // Attach token to outbound request
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}TaskMaster/FetchAPIReportingAsync");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> changepassword([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Put, $"{_baseUrl}Account/changepassword");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpPost("FetchAPIEmployeeTimesheetAsync")]
        public async Task<IActionResult> FetchAPIEmployeeTimesheetAsync([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}TaskMaster/FetchAPIEmployeeTimesheetAsync");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpGet("Getsubordinatedashboard")]
        public async Task<IActionResult> Getsubordinatedashboard([FromQuery] string? searchtext)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}TaskMaster/Getsubordinatedashboard?searchtext={searchtext}");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        [Authorize]
        [HttpGet("Getdepartmentdashboard")]
        public async Task<IActionResult> Getdepartmentdashboard([FromQuery] string? searchtext)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}TaskMaster/Getdepartmentdashboard?searchtext={searchtext}");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        [Authorize]
        [HttpGet("GetNotificationsdashboard")]
        public async Task<IActionResult> GetNotificationsdashboard([FromQuery] string? searchtext)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}TaskMaster/GetNotificationsdashboard?searchtext={searchtext}");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> Getemployeekradetails([FromBody] monthr month)
        {
            try
            {
                ...
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(month), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
                string json = body;
                return StatusCode((int)response.StatusCode, json);
        ...
        public async Task<IActionResult> Getmetadetaildata([FromQuery] int itaskno)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(jwtToken))
                    return Unauthorized("Missing Authorization token.");
                // 🔗 Build full URL with encrypted query             
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/TaskMaster/Getmetadetaildata?itaskno={itaskno}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> FetchGetapiIntegration([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}APIIntegrationController/FetchGetapiIntegration");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpPost("Createprocessraiselimit")]
        public async Task<IActionResult> Createprocessraiselimit([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}ProcessEngine/Createprocessraiselimit");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        [Authorize]
        [HttpPut("Updateprocessraiselimit")]
        public async Task<IActionResult> Updateprocessraiselimit([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Put, $"{_baseUrl}ProcessEngine/Updateprocessraiselimit");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Getprocessraiselimit([FromQuery] int id)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(jwtToken))
                    return Unauthorized("Missing Authorization token.");
                // 🔗 Build full URL with encrypted query             
                string targetUrl = $"{_baseUrl.TrimEnd('/')}/ProcessEngine/Getprocessraiselimit?id={id}";
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, targetUrl);
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
        ...
        public async Task<IActionResult> PostInoutboundAPIAsync([FromBody] pay request)
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Post, $"{_baseUrl}APIIntegration/PostInoutboundAPIAsync");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
                requestMessage.Content = new StringContent(JsonConvert.SerializeObject(request), Encoding.UTF8, "application/json");
                var response = await _httpClient.SendAsync(requestMessage);
                var body = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Getcalendarevents()
        {
            try
            {
                ...
                var requestMessage = new HttpRequestMessage(HttpMethod.Get, $"{_baseUrl}TaskMaster/Getcalendarevents");
                requestMessage.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", jwtToken.Split(" ").Last());
