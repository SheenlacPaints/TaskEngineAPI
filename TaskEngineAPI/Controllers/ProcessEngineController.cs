...
namespace TaskEngineAPI.Controllers
{
    ...
    public class ProcessEngineController : ControllerBase
    {
        ...
        //public async Task<IActionResult> GetAllProcessEnginenew(
        //    string? searchText,
        //    int page = 1,
        //    int pageSize = 10,
        ...
        //        if (!string.IsNullOrWhiteSpace(created_by) && created_by.Length > 100)
        //        {
        //            return CreateEncryptedResponse(400, "Created_by parameter cannot exceed 100 characters");
        //        }
        ...
        //            {
        //                return CreateEncryptedResponse(400, $"Invalid priority. Must be one of: {string.Join(", ", validPriorities)}");
        //            }
        //        }

        //        if (status.HasValue && (status.Value < 0 || status.Value > 10))
        //        {
        //            return CreateEncryptedResponse(400, "Status must be between 0 and 10");
        //        }
