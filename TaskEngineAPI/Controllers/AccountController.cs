...
namespace TaskEngineAPI.Controllers
{
...

    {
        ...
        //[HttpPost("CreateUsersBulkss")]
        //public async Task<IActionResult> CreateUsersBulkss([FromBody] pay request)
        //{
        //    try
        //    {
        //        string decryptedJson = AesEncryption.Decrypt(request.payload);
        ...
        //            if (usernameExists) errors.Add("Username exists in database");
        //            if (emailExists) errors.Add("Email exists in database");
        //            if (phoneExists) errors.Add("Phone number exists in database");
