...
namespace TaskEngineAPI.Interfaces
{
    ...
    public interface IProcessEngineService
    {
        ...
        Task<GetProcessEngineCountDTO> GetAllProcessengineAsync(int cTenantID, string searchText = null, int page = 1, int pageSize = 10, int? created_by = null, string priority = null, int? status = null);
