...
VALUES (
    ...
    SELECT [ID], [cuserid], [ctenant_id], [cuser_name], [cemail], [cpassword], [nIs_active],
          ...
          [cwork_loc_code], [cwork_loc_name], [crole_id], [crole_code], [crole_name], [cgrade_code],
          [cgrade_desc], [csub_role_code], [cdept_code], [cdept_desc], [cjob_code], [cjob_desc],
          [creport_mgr_code], [creport_mgr_name], [croll_id], [croll_name], [croll_id_mngr],
          [cRoll_id_mngr_desc], [creport_manager_empcode], [creport_manager_poscode],
          [creport_manager_pos_desc], [nis_web_access_enabled], [nis_event_read], [llast_login_at],
          [nfailed_logina_attempts], [cpassword_changed_at], [nis_locked], [last_login_ip],
          [last_login_device], [ccreated_date], [ccreated_by], [lmodified_date],[cmodified_by],
          [nIs_deleted], [cdeleted_by], [ldeleted_date], [cprofile_image_name], [cprofile_image_path],[cposition_code],[cposition_name]
   FROM [dbo].[Users]
   WHERE crole_id = 3 AND ctenant_id = @TenantID  and cuserid=@userid";
        ...
        public async Task<int> InsertUsersBulkAsync(List<BulkUserDTO> users, int cTenantID, string usernameClaim)
        {
            ...
            foreach (var u in users)
            {
                ...
                row["cprofile_image_name"] = DBNull.Value;
                row["cprofile_image_path"] = DBNull.Value;
        ...
        public async Task<bool> InsertUserApiAsync(UserApiDTO user, int cTenantID, string usernameClaim)
        {
            ...
            var row = table.NewRow();
            row["cuserid"] = user.cuserid;
            row["ctenant_id"] = cTenantID;
            row["cuser_name"] = user.cusername ?? (object)DBNull.Value;
            row["cpassword"] = user.cpassword ?? (object)DBNull.Value;
            row["cemail"] = user.cemail ?? (object)DBNull.Value;
            row["nIs_active"] = true;
            row["cfirst_name"] = user.cfirstName ?? (object)DBNull.Value;
            row["clast_name"] = user.clastName ?? (object)DBNull.Value;
            row["cphoneno"] = user.cphoneno ?? (object)DBNull.Value;
            row["calternate_phone"] = user.cAlternatePhone ?? (object)DBNull.Value;
            row["ldob"] = user.ldob ?? (object)DBNull.Value;
            row["cmarital_status"] = user.cMaritalStatus ?? (object)DBNull.Value;
            row["cnation"] = user.cnation ?? (object)DBNull.Value;
            row["cgender"] = user.cgender ?? (object)DBNull.Value;
            row["caddress"] = user.caddress ?? (object)DBNull.Value;
            row["caddress1"] = user.caddress1 ?? (object)DBNull.Value;
            row["caddress2"] = user.caddress2 ?? (object)DBNull.Value;
            row["cpincode"] = user.cpincode ?? (object)DBNull.Value;
            row["ccity"] = user.ccity ?? (object)DBNull.Value;
            row["cstate_code"] = user.cstatecode ?? (object)DBNull.Value;
            row["cstate_desc"] = user.cstatedesc ?? (object)DBNull.Value;
            row["ccountry_code"] = user.ccountrycode ?? (object)DBNull.Value;
            row["profile_image"] = DBNull.Value;
            row["cbank_name"] = user.cbankName ?? (object)DBNull.Value;
            row["caccount_number"] = user.caccountNumber ?? (object)DBNull.Value;
            row["ciFSC_code"] = user.ciFSC_code ?? (object)DBNull.Value;
            row["cpan"] = user.cpAN ?? (object)DBNull.Value;
            row["ldoj"] = user.ldoj ?? (object)DBNull.Value;
            row["cemployment_status"] = user.cemploymentStatus ?? (object)DBNull.Value;
            row["nnotice_period_days"] = user.nnoticePeriodDays ?? (object)DBNull.Value;
            row["lresignation_date"] = DBNull.Value;
            row["llast_working_date"] = DBNull.Value;
            row["cemp_category"] = user.cempcategory ?? (object)DBNull.Value;
            row["cwork_loc_code"] = user.cworkloccode ?? (object)DBNull.Value;
            row["cwork_loc_name"] = user.cworklocname ?? (object)DBNull.Value;
            row["crole_id"] = 3;
            row["crole_code"] = usernameClaim;
            row["crole_name"] = usernameClaim;
            row["cgrade_code"] = user.cgradecode ?? (object)DBNull.Value;
            row["cgrade_desc"] = user.cgradedesc ?? (object)DBNull.Value;
            row["csub_role_code"] = user.csubrolecode ?? (object)DBNull.Value;
            row["cdept_code"] = user.cdeptcode ?? (object)DBNull.Value;
            row["cdept_desc"] = user.cdeptdesc ?? (object)DBNull.Value;
            row["cjob_code"] = user.cjobcode ?? (object)DBNull.Value;
            row["cjob_desc"] = user.cjobdesc ?? (object)DBNull.Value;
            row["creport_mgr_code"] = user.creportmgrcode ?? (object)DBNull.Value;
            row["creport_mgr_name"] = user.creportmgrname ?? (object)DBNull.Value;
            row["croll_id"] = user.croll_id ?? (object)DBNull.Value;
            row["croll_name"] = user.croll_name ?? (object)DBNull.Value;
            row["croll_id_mngr"] = user.croll_id_mngr ?? (object)DBNull.Value;
            row["croll_id_mngr_desc"] = user.croll_id_mngr_desc ?? (object)DBNull.Value;
            row["creport_manager_empcode"] = user.cReportManager_empcode ?? (object)DBNull.Value;
            row["creport_manager_poscode"] = user.cReportManager_Poscode ?? (object)DBNull.Value;
            row["creport_manager_pos_desc"] = user.cReportManager_Posdesc ?? (object)DBNull.Value;
            row["nis_web_access_enabled"] = true;
            row["nis_event_read"] = true;
            row["llast_login_at"] = DBNull.Value;
            row["nfailed_logina_attempts"] = 0;
                    ...
                    using (HttpClient client = new HttpClient())
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(_config.GetConnectionString("Database")))
                        {
                            ...
                            (
                                ...
                                ldob,cmarital_status,cnation,cgender,caddress,caddress1,caddress2,cpincode,ccity,cstate_code,cstate_desc,cbank_name,
                               caccount_number,ciFSC_code,cpan,cdept_code,cdept_desc,creport_mgr_code,creport_mgr_name,cposition_code,cposition_name,
                               creport_manager_empcode,creport_manager_poscode,creport_manager_pos_desc,cemployment_status,cemp_category,ldoj,nnotice_period_days,SyncDate,BatchId
                            )
                            VALUES
                            (
                                @TenantId, @cuserid, @cuser_name,@cemail,@cpassword,@nIs_active,@cfirst_name,@clast_name,@cphoneno,@calternate_phone,
                                @ldob,@cmarital_status,@cnation,@cgender,@caddress,@caddress1,@caddress2,@cpincode,@ccity,@cstate_code,@cstate_desc,@cbank_name,
                               @caccount_number,@ciFSC_code,@cpan,@cdept_code,@cdept_desc,@creport_mgr_code,@creport_mgr_name,@cposition_code,@cposition_name,
                               @creport_manager_empcode,@creport_manager_poscode,@creport_manager_pos_desc,@cemployment_status,@cemp_category,@ldoj,@nnotice_period_days,GETDATE(),@BatchId
                            )";
